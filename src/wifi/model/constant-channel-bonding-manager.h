...
#ifndef CONSTANT_CHANNEL_BONDING_MANAGER_H
#define CONSTANT_CHANNEL_BONDING_MANAGER_H
...
/**
 * \brief Constant Channel Bonding Manager
 * \ingroup wifi
 *
 * This object provides an implementation for dynamically selecting the channel width.
 *
 */
class ConstantChannelBondingManager : public ChannelBondingManager
{
public:
...
#endif /* CONSTANT_CHANNEL_BONDING_MANAGER_H */
