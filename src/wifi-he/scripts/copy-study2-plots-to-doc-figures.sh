...
cp "./images/png/throughput-study2.png" ../doc/source/figures/.
cp "./images/png/area-capacity-study2.png" ../doc/source/figures/.
cp "./images/png/spectrum-efficiency-study2.png" ../doc/source/figures/.
