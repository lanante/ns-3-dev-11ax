...
grep 'Throughput,  AP3 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-throughput-ap3.dat
grep 'Throughput,  AP4 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-throughput-ap4.dat
grep 'Throughput,  AP5 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-throughput-ap5.dat
grep 'Throughput,  AP6 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-throughput-ap6.dat
...
grep 'Area Capacity, AP3 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-area-capacity-ap3.dat
grep 'Area Capacity, AP4 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-area-capacity-ap4.dat
grep 'Area Capacity, AP5 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-area-capacity-ap5.dat
grep 'Area Capacity, AP6 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-area-capacity-ap6.dat
...
grep 'Spectrum Efficiency, AP3 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-spectrum-efficiency-ap3.dat
grep 'Spectrum Efficiency, AP4 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-spectrum-efficiency-ap4.dat
grep 'Spectrum Efficiency, AP5 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-spectrum-efficiency-ap5.dat
grep 'Spectrum Efficiency, AP6 Uplink' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-spectrum-efficiency-ap6.dat
...
grep 'Air-time utilization, AP3' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-airtime-utilization-ap3.dat
grep 'Air-time utilization, AP4' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-airtime-utilization-ap4.dat
grep 'Air-time utilization, AP5' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-airtime-utilization-ap5.dat
grep 'Air-time utilization, AP6' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-airtime-utilization-ap6.dat
grep 'Air-time utilization, AP7' ./results/spatial-reuse-SR-stats-study2-*.dat > ./results/spatial-reuse-study2-airtime-utilization-ap7.dat
