...
# Uncoupled BSSes with all DL throughput
...
echo "Expected Throughput: 40.9 Mbit/s per BSS, regardless of nSTA"

export downlink=500.0
export n=5
export test="bianchi-test1-dl-only-n5"
run_one &

export downlink=1000.0
export n=10
export test="bianchi-test1-dl-only-n10"
run_one &

export downlink=1500.0
export n=15
export test="bianchi-test1-dl-only-n15"
run_one &

export downlink=2000.0
export n=20
export test="bianchi-test1-dl-only-n20"
run_one &

export downlink=2500.0
export n=25
export test="bianchi-test1-dl-only-n25"
run_one &

export downlink=3000.0
export n=30
export test="bianchi-test1-dl-only-n30"
run_one &

export downlink=3500.0
export n=35
export test="bianchi-test1-dl-only-n35"
run_one &
