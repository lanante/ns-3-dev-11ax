    ...
    for ap in ap1 ; do
        for offeredLoad in 2.0 ; do
            ...
            for i in $(seq 1 $n); do
                ...
                grep "$grepPattern" "./results/spatial-reuse-SR-stats-study2-$patt.dat" >> ./results/plot_tmp.dat
            done
            ...
            echo "plotting"
            python ecdf2.py "xxx-$patt-$ap-ecdf.dat" 4 0 0 0 0 "./results/study2-$patt-$ap-ecdf.png" 0
