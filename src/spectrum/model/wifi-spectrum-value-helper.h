...
public:
   ...
   */
  static Ptr<SpectrumValue> CreateNoisePowerSpectralDensity (uint32_t centerFrequency, uint16_t channelWidth, double bandBandwidth,
   ...
   */
  static Ptr<SpectrumValue> CreateRfFilter (uint32_t firstCenterFrequency, uint16_t totalChannelWidth, double bandBandwidth,
                                            uint16_t guardBandwidth, uint16_t channelWidthInFilter, uint8_t bandIndex);
