...
cpp_examples = [
    ...
    ("wifi-channel-bonding --channelBssA=36 --channelBssB=40 --maxSupportedChannelWidthBssA=20 --maxSupportedChannelWidthBssB=20 --useDynamicChannelBonding=false --txMaskInnerBandMinimumRejection=-20 --txMaskOuterBandMinimumRejection=-28 --txMaskOuterBandMaximumRejection=-40 --verifyResults=1 --minExpectedThroughputBssA=29 --maxExpectedThroughputBssA=30 --minExpectedThroughputBssB=29 --maxExpectedThroughputBssB=30", "False", "False"), # FIXME
    ("wifi-channel-bonding --channelBssA=38 --channelBssB=40 --maxSupportedChannelWidthBssA=40 --maxSupportedChannelWidthBssB=20 --useDynamicChannelBonding=false --verifyResults=1 --minExpectedThroughputBssA=21 --maxExpectedThroughputBssA=22 --minExpectedThroughputBssB=0 --maxExpectedThroughputBssB=1", "True", "False"),
    ("wifi-channel-bonding --channelBssA=38 --channelBssB=40 --maxSupportedChannelWidthBssA=40 --maxSupportedChannelWidthBssB=20 --useDynamicChannelBonding=true --verifyResults=1 --minExpectedThroughputBssA=59 --maxExpectedThroughputBssA=60 --minExpectedThroughputBssB=59 --maxExpectedThroughputBssB=60", "True", "False"),
    ("wifi-channel-bonding --channelBssA=38 --channelBssB=38 --maxSupportedChannelWidthBssA=40 --maxSupportedChannelWidthBssB=40 --useDynamicChannelBonding=false --verifyResults=1 --minExpectedThroughputBssA=50 --maxExpectedThroughputBssA=55 --minExpectedThroughputBssB=50 --maxExpectedThroughputBssB=55", "True", "False"),
]
