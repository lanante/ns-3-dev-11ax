...
cpp_examples = [
    ...
    ("ht-wifi-network --simulationTime=0.2 --frequency=5 --useRts=1 --minExpectedThroughput=5 --maxExpectedThroughput=131", "True", "True"),
    ("ht-wifi-network --simulationTime=0.2 --frequency=2.4 --useRts=0 --minExpectedThroughput=5 --maxExpectedThroughput=132", "True", "True"),
    ("ht-wifi-network --simulationTime=0.2 --frequency=2.4 --useRts=1 --minExpectedThroughput=5 --maxExpectedThroughput=128", "True", "True"),
    ("vht-wifi-network --simulationTime=0.2 --useRts=0  --minExpectedThroughput=5 --maxExpectedThroughput=562", "True", "True"),
    ("vht-wifi-network --simulationTime=0.2 --useRts=1  --minExpectedThroughput=5 --maxExpectedThroughput=522", "True", "True"),
    ...
    ("wifi-channel-bonding --channelBssA=38 --channelBssB=40 --useDynamicChannelBonding=false --verifyResults=1 --minExpectedThroughputBssA=80 --maxExpectedThroughputBssA=81 --minExpectedThroughputBssB=17 --maxExpectedThroughputBssB=18", "True", "False"),
    ...
    ("wifi-channel-bonding --channelBssA=38 --channelBssB=38 --useDynamicChannelBonding=false --verifyResults=1 --minExpectedThroughputBssA=60 --maxExpectedThroughputBssA=65 --minExpectedThroughputBssB=60 --maxExpectedThroughputBssB=65", "True", "False"),
]
