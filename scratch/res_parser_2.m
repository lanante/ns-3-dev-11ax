...
% axis([0 4 0 1.2]);
% grid
% xlabel('BSS-1 DL Throughput (Mbps)');
% ylabel('Cumulative Distribution');
% legend('Sec. CCH Thresh.=-82','Sec. CCH Thresh.=-72','Sec. CCH Thresh.=-62','Proposed', 'Position',[0.55238095993797 0.121031782740638 0.34464284958584 0.155952376694906]);
% annotation('ellipse',...
...
%     'Position',[2.718779342723 0.643695014662757 0]);
...
ylabel('Cumulative Distribution');
legend('Sec. CCH Thresh.=-82','Sec. CCH Thresh.=-72','Sec. CCH Thresh.=-62','Proposed', 'Position',[0.55238095993797 0.121031782740638 0.34464284958584 0.155952376694906]);
text(6,0.8,['+60% Improvement']);
text(3.7,0.5,['+13% Improvement']);
...
% xlabel('BSS-1 DL Throughput (Mbps)');
% ylabel('Cumulative Distribution');
% legend('Sec. CCHA Thresh.=-82','Sec. CCHA Thresh.=-72','Sec. CCHA Thresh.=-62','Proposed', 'Position',[0.55238095993797 0.121031782740638 0.34464284958584 0.155952376694906]);
% text(3,0.5,'+2100% Improvement');
% text(7.5,0.9,'+74% Improvement');
