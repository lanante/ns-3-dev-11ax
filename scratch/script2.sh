...
../../waf --run "wifi-channel-bonding  --channelBssA=36 --channelBssB=38 --secondaryChannelBssB=LOWER --useDynamicChannelBonding=true --distance=1 --interBssDistance=20 --ccaEdThresholdSecondaryBssB=-100"
